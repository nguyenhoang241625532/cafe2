...
public class pnlQLBH extends javax.swing.JPanel {
    ...
    void setEventValueChanged() {
        ...
        txtKhachDua.getDocument().addDocumentListener(new DocumentListener() {
            ...
            public void insertUpdate(DocumentEvent e) {
                ...
                if (txtKhachDua.getText().equals("0")) {
                    txtTraLai.setText("-" + txtPhaiTra.getText());
                    return;
                }
                ...
                try {
                    if(txtKhachDua.getText().equals("")){
                        KhachDua = DinhDangTien.parse("0").longValue();
                    }else{
                        KhachDua = DinhDangTien.parse(txtKhachDua.getText()).longValue();
                    }
                ...
                txtTraLai.setText(String.valueOf(DinhDangTien.format(KhachDua - PhaiTra)));
                if (txtTraLai.getText().contains("-")) {
                    btnGoiMon.hide();
                    btnThanhToan.hide();
                } else {
                    btnGoiMon.show();
    ...
    void SaveOrder(String MaBan, String TrangThai, long TriGia, String MaKM, long PhaiTra, Vector CTOrder) {
        ...
        System.out.print("rerererereree"+CTOrder.toString());
...
System.out.print("run2");
                    ...
                    if (btnTable.getTrangThai().equals(ConstantClass.FREE_STATUS)) {
                        ...
                        tblOrder.setModel(TableModel);
                        SetTableModelListener();
                        System.out.print("dgfdgdgdgd"+QLBanHangController.getInstance().getMaOrder(txtID.getText()));
                        //get Tổng tiền
                        Order current = QLBanHangController.getInstance().getOrder(QLBanHangController.getInstance().getMaOrder(txtID.getText()));
                        System.out.print("dgfdgdgdgd"+current.getMaKM());
    ...
    private void initComponents() {
        ...
        txtKhachDua.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        txtKhachDua.setText("0");
        txtKhachDua.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                txtKhachDuaPropertyChange(evt);
            }
        });

        txtTraLai.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        txtTraLai.setText("0");
            ...
            .addGroup(pnlOrderLayout.createSequentialGroup()
                .addGroup(pnlOrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pnlOrderLayout.createSequentialGroup()
                        ...
                        .addGap(4, 4, 4)
                        .addComponent(txtKhachDua, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(pnlOrderLayout.createSequentialGroup()
                        .addGroup(pnlOrderLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        pnlFunctionKey.add(InHD);
        InHD.setBounds(240, 90, 100, 40);
        ...
        if (choose == JOptionPane.YES_OPTION) {
           // JOptionPane.showMessageDialog(null, "In hoá đơn nè!", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
            ...
            Connection conn=(Connection)DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:orcl", "cafe", "cafe");
             JasperDesign jd=JRXmlLoader.load("F:\\u\\cafe\\QuanLyQuanCafe\\src\\Music\\report2.jrxml");
            JasperReport jr= JasperCompileManager.compileReport("F:\\u\\cafe\\QuanLyQuanCafe\\src\\Music\\report2.jrxml");
    ...
    private void txtKhachDuaPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_txtKhachDuaPropertyChange
        // TODO add your handling code here:    
    }//GEN-LAST:event_txtKhachDuaPropertyChange
    ...
    private void btnThanhToanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThanhToanActionPerformed
        ...
        HoaDonController.getInstance().ThemHoaDon(cmbKM.getSelectedItem().toString(), sqlDate,Integer.parseInt(txtTongTien.getText().replaceAll(",", "")) , Integer.parseInt(txtPhaiTra.getText().replaceAll(",", "")) , Integer.parseInt(txtKhachDua.getText().replaceAll(",", "")), Integer.parseInt(txtTraLai.getText().replaceAll(",", "")));
