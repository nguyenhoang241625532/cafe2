...
public class QLKMController {
    ...
    public boolean ThemKM(String MaKM, String TenKM, Date NgayBatDau, Date NgayKetThuc, String LoaiKM, long TriGiaApDung, long TriGiaKM)
    {
      ...
      public boolean CapNhatKM(String MaKM, String TenKM, Date NgayBatDau, Date NgayKetThuc, String LoaiKM, long TriGiaApDung, long TriGiaKM) {
       KhuyenMai value = new KhuyenMai(MaKM, TenKM, NgayBatDau, NgayKetThuc, LoaiKM, TriGiaApDung, TriGiaKM);
        
        return QLKMModel.getInstance().CapNhatKM(value); //To change body of generated methods, choose Tools | Templates.
    }
      public boolean XoaKhuyenMai(String MaKM)
    {
        return QLKMModel.getInstance().XoaKhuyenMai(MaKM);
    }
